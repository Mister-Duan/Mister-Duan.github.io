...
declare const revealJsPlugin: ({ plugins, themes, layout, delay, }?: RevealJsPluginOptions) => Plugin;

export { type RevealJsPlugin, type RevealJsPluginOptions, revealJs, revealJsPlugin };
