...
interface AppendDatePluginOptions {
    /**
...
declare const appendDatePlugin: (options?: AppendDatePluginOptions) => PluginObject;

export { type AppendDatePluginOptions, appendDatePlugin };
