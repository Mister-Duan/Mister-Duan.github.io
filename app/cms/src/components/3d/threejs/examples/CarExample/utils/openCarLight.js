...
import { directionalLight, directionalLight2, ambient } from "./scene.js";
import { LensflareJpg } from "../assets";
// 引入threejs镜头光晕扩展库
import {
  Lensflare,
  LensflareElement,
...
// // 用于镜头光晕的纹理对象
var texture = texLoader.load(LensflareJpg);

// 创建两个镜头光晕Lensflare对象，分别用来模拟车前面左右两个车灯的发光效果，具体位置查看model.js文件
var lensflareElement = new LensflareElement(
  texture,
  600,
  0,
