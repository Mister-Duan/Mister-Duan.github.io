<template><div><h2 id="其他特性" tabindex="-1"><a class="header-anchor" href="#其他特性"><span>其他特性</span></a></h2>
<h3 id="自动链接" tabindex="-1"><a class="header-anchor" href="#自动链接"><span>自动链接</span></a></h3>
...
<p>Markdown 可以利用反斜线来插入一些在语法中有其它意义的符号，例如: 如果您想要用星号加在文字旁边的方式来做出强调效果 (但不用 <code v-pre>&lt;em&gt;</code> 标签) ，您可以在星号的前面加上反斜线:</p>
...
<ul>
<li><code v-pre>\</code> 反斜线</li>
<li><code v-pre>`</code> 反引号</li>
<li><code v-pre>*</code> 星号</li>
<li><code v-pre>_</code> 底线</li>
<li><code v-pre>{}</code> 大括号</li>
<li><code v-pre>[]</code> 方括号</li>
<li><code v-pre>()</code> 括号</li>
<li><code v-pre>#</code> 井字号</li>
<li><code v-pre>+</code> 加号</li>
<li><code v-pre>-</code> 减号</li>
<li><code v-pre>.</code> 英文句点</li>
<li><code v-pre>!</code> 惊叹号</li>
</ul>
<h2 id="大部分编辑器通用快捷键" tabindex="-1"><a class="header-anchor" href="#大部分编辑器通用快捷键"><span>大部分编辑器通用快捷键</span></a></h2>
<table>
<thead>
<tr>
<th>输出后的效果</th>
...
<tr>
<td><code v-pre>Inline Code</code></td>
<td>`code`</td>
<td>选中后 <code v-pre>`</code></td>
</tr>
</tbody>
</table>
<h2 id="常见扩展" tabindex="-1"><a class="header-anchor" href="#常见扩展"><span>常见扩展</span></a></h2>
...
<p>表格是 GFM 标准支持的格式。</p>
<p>您需要创建表头，并使用 <code v-pre>---</code> 来分割表头和表身。</p>
<p>您需要使用 <code v-pre>|</code> 来分割每一个表格项目，如果您需要输入 <code v-pre>|</code> 请使用 <code v-pre>\</code> 转义它。</p>
<p>您可以在表头分割行处使用 <code v-pre>:</code> 来自定义该列的对其</p>
...
<h3 id="emoji" tabindex="-1"><a class="header-anchor" href="#emoji"><span>Emoji</span></a></h3>
<p>Emoji 是 GFM 标准支持的格式，需要通过 <code v-pre>:emoji名称:</code> 来使用 emoji。</p>
<p>例子: <code v-pre>:smile:</code> 😄</p>
<p>您可以在 <RouteLink to="/code/language/markdown/emoji/">Emoji 列表</RouteLink> 找到所有可用的 Emoji。</p>
<h3 id="删除线" tabindex="-1"><a class="header-anchor" href="#删除线"><span>删除线</span></a></h3>
<p>您可以使用 <code v-pre>~~delete~~</code> 来创建类似 <s>delete</s> 的删除线</p>
<h3 id="脚注" tabindex="-1"><a class="header-anchor" href="#脚注"><span>脚注</span></a></h3>
<p>在 Markdown 中使用 <code v-pre>[^锚点文字]</code> 来定义脚注。</p>
<p>在之后的任何位置使用 <code v-pre>[^锚点文字]: ...</code> 来描述脚注内容。</p>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#986801;--shiki-dark:#D19A66">[^second]</span><span style="--shiki-light:#986801;--shiki-dark:#ABB2BF">: </span><span style="--shiki-light:#A626A4;--shiki-light-text-decoration:inherit;--shiki-dark:#C678DD;--shiki-dark-text-decoration:underline">脚注文字。</span></span></code></pre>
...
<p>重复的页脚引用<sup class="footnote-ref"><a href="#footnote2">[2:1]</a><a class="footnote-anchor" id="footnote-ref2:1" /></sup>.</p>
</details>
...
<details class="hint-container details"><summary>例子</summary>
<p><strong>输入</strong>:</p>
<div class="language-md" data-highlighter="shiki" data-ext="md" data-title="md" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#E45649;--shiki-dark:#E06C75">### My Great Heading {#custom-id}</span></span></code></pre>
...
<h3 id="定义列表" tabindex="-1"><a class="header-anchor" href="#定义列表"><span>定义列表</span></a></h3>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">: This is another definition of the second term.</span></span></code></pre>
</div><p><strong>渲染结果</strong>:</p>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">&#x3C;/</span><span style="--shiki-light:#E45649;--shiki-dark:#E06C75">dl</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">></span></span></code></pre>
</div><p><strong>输出</strong>:</p>
...
<h3 id="任务列表" tabindex="-1"><a class="header-anchor" href="#任务列表"><span>任务列表</span></a></h3>
<p>任务列表使您可以创建带有复选框的项目列表。</p>
<p>要创建任务列表，请创建一个列表，并以方括号 <code v-pre>[ ]</code> 开头。通过添加空格 <code v-pre>x</code> 来改变复选框的勾选情况。</p>
<details class="hint-container details"><summary>例子</summary>
<p><strong>输入</strong>:</p>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#E5C07B">-</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF"> [ ] Contact the media</span></span></code></pre>
</div><p><strong>输出</strong>:</p>
<ul>
