<template><div><h1 id="如何学习一门计算机语言" tabindex="-1"><a class="header-anchor" href="#如何学习一门计算机语言"><span>如何学习一门计算机语言</span></a></h1>
...
<h3 id="语句" tabindex="-1"><a class="header-anchor" href="#语句"><span>语句</span></a></h3>
...
</div><h3 id="代码块" tabindex="-1"><a class="header-anchor" href="#代码块"><span>代码块</span></a></h3>
...
<div class="language-text" data-highlighter="shiki" data-ext="text" data-title="text" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>{</span></span>
...
</div><p>大多数语言会使用 <code v-pre>{ }</code> 的形式，少数语言会使用统一的缩进进行表达。</p>
<h2 id="数据结构" tabindex="-1"><a class="header-anchor" href="#数据结构"><span>数据结构</span></a></h2>
...
<li>
<p>布尔值:</p>
<p>几乎所有语言都有布尔值，布尔值只有真和假两种类型。大多数会表示为 <code v-pre>true</code> 和 <code v-pre>false</code>，少数会表示为 <code v-pre>True</code> 和 <code v-pre>False</code>。</p>
</li>
<li>
<p>数组:</p>
...
</div><h2 id="条件" tabindex="-1"><a class="header-anchor" href="#条件"><span>条件</span></a></h2>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">}</span></span></code></pre>
</div><h2 id="循环" tabindex="-1"><a class="header-anchor" href="#循环"><span>循环</span></a></h2>
