...
<!-- more -->
<h2 id="javascript-简介" tabindex="-1"><a class="header-anchor" href="#javascript-简介"><span>JavaScript 简介</span></a></h2>
...
<p>JavaScript 的核心语法部分相当精简，只包括两个部分: 基本的语法构造(比如操作符、控制结构、语句)和标准库(就是一系列具有各种功能的对象比如 <code v-pre>Array</code>、<code v-pre>Date</code>、<code v-pre>Math</code> 等)。除此之外，各种宿主环境提供额外的 API(即只能在该环境使用的接口)，以便 JavaScript 调用。以浏览器为例，它提供的额外 API 可以分成三大类。</p>
<ul>
<li>浏览器控制类: 操作浏览器</li>
...
<h2 id="学习-javascript-的原因" tabindex="-1"><a class="header-anchor" href="#学习-javascript-的原因"><span>学习 JavaScript 的原因</span></a></h2>
<p>JavaScript 语言有一些显著特点，使得它非常值得学习。它既适合作为学习编程的入门语言，也适合当作日常开发的工作语言。它是目前最有希望、前途最光明的计算机语言之一。</p>
<h3 id="操控浏览器的能力" tabindex="-1"><a class="header-anchor" href="#操控浏览器的能力"><span>操控浏览器的能力</span></a></h3>
...
<h3 id="广泛的使用领域" tabindex="-1"><a class="header-anchor" href="#广泛的使用领域"><span>广泛的使用领域</span></a></h3>
...
<h3 id="易学性" tabindex="-1"><a class="header-anchor" href="#易学性"><span>易学性</span></a></h3>
...
<h3 id="强大的性能" tabindex="-1"><a class="header-anchor" href="#强大的性能"><span>强大的性能</span></a></h3>
...
<h3 id="开放性" tabindex="-1"><a class="header-anchor" href="#开放性"><span>开放性</span></a></h3>
...
<h3 id="社区支持和就业机会" tabindex="-1"><a class="header-anchor" href="#社区支持和就业机会"><span>社区支持和就业机会</span></a></h3>
