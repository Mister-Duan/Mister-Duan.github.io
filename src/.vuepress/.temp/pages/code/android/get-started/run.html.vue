<template><div><h2 id="在真实设备上运行" tabindex="-1"><a class="header-anchor" href="#在真实设备上运行"><span>在真实设备上运行</span></a></h2>
<p>按照以下步骤设置设备：</p>
<ol>
<li>
...
<h2 id="在模拟器上运行" tabindex="-1"><a class="header-anchor" href="#在模拟器上运行"><span>在模拟器上运行</span></a></h2>
