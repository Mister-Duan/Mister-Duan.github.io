<template><div><p>本部分介绍如何构建简单的 Android 应用。首先，您将了解如何通过 Android Studio 创建“Hello, World!”项目并运行它。然后，您将为应用创建一个新界面，该界面会接受用户输入，并切换到应用中的一个新屏幕以显示用户输入内容。</p>
<p>开始之前，您需要了解有关 Android 应用的两个基本概念：它们如何提供多个入口点，以及它们如何适应不同的设备。</p>
<!-- more -->
<h2 id="应用提供多个入口点" tabindex="-1"><a class="header-anchor" href="#应用提供多个入口点"><span>应用提供多个入口点</span></a></h2>
...
<h2 id="应用可适应不同的设备" tabindex="-1"><a class="header-anchor" href="#应用可适应不同的设备"><span>应用可适应不同的设备</span></a></h2>
