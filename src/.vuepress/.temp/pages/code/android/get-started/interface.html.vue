<template><div><p>在本节课中，您将学习如何使用 Android Studio 布局编辑器创建包含一个文本框和一个按钮的布局。这将为下一课打下基础，下节课将学习如何在点按该按钮时让应用将文本框的内容发送到其他 activity。</p>
<!-- more -->
<p>Android 应用的界面 (UI) 以布局和微件的层次结构形式构建而成。布局是 ViewGroup 对象，即控制其子视图在屏幕上的放置方式的容器。微件是 View 对象，即按钮和文本框等界面组件。</p>
<figure><img src="@source/code/android/get-started/assets/viewgroup.png" alt="ViewGroup" tabindex="0" loading="lazy"><figcaption>ViewGroup</figcaption></figure>
...
<h2 id="打开布局编辑器" tabindex="-1"><a class="header-anchor" href="#打开布局编辑器"><span>打开布局编辑器</span></a></h2>
<p>首先，请按照以下步骤设置工作区：</p>
<ol>
...
<p>您的布局编辑器现在如下图所示。</p>
<figure><img src="@source/code/android/get-started/assets/layout-editor.png" alt="布局编辑器" tabindex="0" loading="lazy"><figcaption>布局编辑器</figcaption></figure>
...
<figure><img src="@source/code/android/get-started/assets/constraint-example.png" alt="布局示例" tabindex="0" loading="lazy"><figcaption>布局示例</figcaption></figure>
<h2 id="添加文本框" tabindex="-1"><a class="header-anchor" href="#添加文本框"><span>添加文本框</span></a></h2>
<p>请按照下面的步骤添加文本框：</p>
<ol>
...
<h2 id="添加按钮" tabindex="-1"><a class="header-anchor" href="#添加按钮"><span>添加按钮</span></a></h2>
<ol>
...
<h2 id="更改界面字符串" tabindex="-1"><a class="header-anchor" href="#更改界面字符串"><span>更改界面字符串</span></a></h2>
...
<h2 id="让文本框大小可灵活调整" tabindex="-1"><a class="header-anchor" href="#让文本框大小可灵活调整"><span>让文本框大小可灵活调整</span></a></h2>
