<template><div><p>微信小程序运行在多种平台上: iOS(iPhone/iPad)微信客户端、Android 微信客户端、PC 微信客户端、Mac 微信客户端和用于调试的微信开发者工具。</p>
...
<h2 id="平台差异" tabindex="-1"><a class="header-anchor" href="#平台差异"><span>平台差异</span></a></h2>
