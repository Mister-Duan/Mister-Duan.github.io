<template><div><p>类似于页面，自定义组件拥有自己的 wxml 模板和 wxss 样式。</p>
<h2 id="组件模板" tabindex="-1"><a class="header-anchor" href="#组件模板"><span>组件模板</span></a></h2>
<p>组件模板的写法与页面模板相同。组件模板与组件数据结合后生成的节点树，将被插入到组件的引用位置上。</p>
<p>在组件模板中可以提供一个 <code v-pre>&lt;slot&gt;</code> 节点，用于承载组件引用时提供的子节点。</p>
...
<h2 id="模板数据绑定" tabindex="-1"><a class="header-anchor" href="#模板数据绑定"><span>模板数据绑定</span></a></h2>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">  &#x3C;/</span><span style="--shiki-light:#E45649;--shiki-dark:#E06C75">component-tag-name</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">></span></span>
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">&#x3C;/</span><span style="--shiki-light:#E45649;--shiki-dark:#E06C75">view</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">></span></span></code></pre>
</div><p>在以上例子中，组件的属性 <code v-pre>propA</code> 和 <code v-pre>propB</code> 将收到页面传递的数据。页面可以通过 <code v-pre>setData</code> 来改变绑定的数据字段。</p>
</details>
<div class="hint-container warning">
<p class="hint-container-title">注意</p>
<p>这样的数据绑定只能传递 JSON 兼容数据或函数(但这些函数不能在 WXML 中直接调用，只能传递给子组件)。</p>
</div>
<h2 id="组件-wxml-的-slot" tabindex="-1"><a class="header-anchor" href="#组件-wxml-的-slot"><span>组件 wxml 的 slot</span></a></h2>
<p>在组件的 wxml 中可以包含 <code v-pre>slot</code> 节点，用于承载组件使用者提供的 wxml 结构。</p>
<p>默认情况下，一个组件的 wxml 中只能有一个 <code v-pre>slot</code> 。需要使用多 <code v-pre>slot</code> 时，可以在组件 js 中声明启用。</p>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">&#x3C;/</span><span style="--shiki-light:#E45649;--shiki-dark:#E06C75">view</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">></span></span></code></pre>
</div><p>使用时，用 <code v-pre>slot</code> 属性来将节点插入到不同的 slot 上。</p>
<div class="language-xml" data-highlighter="shiki" data-ext="xml" data-title="xml" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#A0A1A7;--shiki-light-font-style:italic;--shiki-dark:#7F848E;--shiki-dark-font-style:italic">&#x3C;!-- 引用组件的页面模板 --></span></span>
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">&#x3C;</span><span style="--shiki-light:#E45649;--shiki-dark:#E06C75">view</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">></span></span>
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">  &#x3C;</span><span style="--shiki-light:#E45649;--shiki-dark:#E06C75">component-tag-name</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">></span></span>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">  &#x3C;/</span><span style="--shiki-light:#E45649;--shiki-dark:#E06C75">component-tag-name</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">></span></span>
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">&#x3C;/</span><span style="--shiki-light:#E45649;--shiki-dark:#E06C75">view</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">></span></span></code></pre>
</div><h2 id="组件样式" tabindex="-1"><a class="header-anchor" href="#组件样式"><span>组件样式</span></a></h2>
<p>组件对应 wxss 文件的样式，只对组件 wxml 内的节点生效。编写组件样式时，需要注意以下几点:</p>
<ul>
<li>组件和引用组件的页面不能使用 id 选择器(<code v-pre>#a</code>)、属性选择器(<code v-pre>[a]</code>)和标签名选择器，请改用 class 选择器。</li>
<li>组件和引用组件的页面中使用后代选择器(<code v-pre>.a .b</code>)在一些极端情况下会有非预期的表现，如遇，请避免使用。</li>
<li>子元素选择器(<code v-pre>.a&gt;.b</code>)只能用于 view 组件与其子节点之间，用于其他组件可能导致非预期的情况。</li>
<li>继承样式，如 <code v-pre>font</code> 、 <code v-pre>color</code> ，会从组件外继承到组件内。</li>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">}</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>除此以外，组件可以指定它所在节点的默认样式，使用 <code v-pre>:host</code> 选择器。</p>
<details class="hint-container details"><summary>代码示例</summary>
...
<h2 id="组件样式隔离" tabindex="-1"><a class="header-anchor" href="#组件样式隔离"><span>组件样式隔离</span></a></h2>
...
<li>指定特殊的样式隔离选项 <code v-pre>styleIsolation</code>。</li>
</ul>
<div class="language-js" data-highlighter="shiki" data-ext="js" data-title="js" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#4078F2;--shiki-dark:#61AFEF">Component</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">({</span></span>
...
<h3 id="styleisolation" tabindex="-1"><a class="header-anchor" href="#styleisolation"><span>styleIsolation</span></a></h3>
<p><code v-pre>styleIsolation</code> 选项从基础库版本 2.6.5 开始支持。它支持以下取值:</p>
<ul>
<li><code v-pre>isolated</code> 表示启用样式隔离，在自定义组件内外，使用 class 指定的样式将不会相互影响(一般情况下的默认值)；</li>
<li><code v-pre>apply-shared</code> 表示页面 wxss 样式将影响到自定义组件，但自定义组件 wxss 中指定的样式不会影响页面；</li>
<li><code v-pre>shared</code> 表示页面 wxss 样式将影响到自定义组件，自定义组件 wxss 中指定的样式也会影响页面和其他设置了 <code v-pre>apply-shared</code> 或 <code v-pre>shared</code> 的自定义组件。(这个选项在插件中不可用。)</li>
</ul>
<p>使用后两者时，请务必注意组件间样式的相互影响。</p>
<p>如果这个 Component 构造器用于构造页面 ，则默认值为 <code v-pre>shared</code> ，且还有以下几个额外的样式隔离选项可用:</p>
<ul>
<li><code v-pre>page-isolated</code> 表示在这个页面禁用 app.wxss ，同时，页面的 wxss 不会影响到其他自定义组件；</li>
<li><code v-pre>page-apply-shared</code> 表示在这个页面禁用 app.wxss ，同时，页面 wxss 样式不会影响到其他自定义组件，但设为 <code v-pre>shared</code> 的自定义组件会影响到页面；</li>
<li><code v-pre>page-shared</code> 表示在这个页面禁用 app.wxss ，同时，页面 wxss 样式会影响到其他设为 <code v-pre>apply-shared</code> 或 <code v-pre>shared</code> 的自定义组件，也会受到设为 <code v-pre>shared</code> 的自定义组件的影响。</li>
</ul>
<p>从小程序基础库版本 2.10.1 开始，也可以在页面或自定义组件的 json 文件中配置 <code v-pre>styleIsolation</code> (这样就不需在 js 文件的 <code v-pre>options</code> 中再配置)。例如:</p>
...
<p>小程序基础库版本 2.2.3 以上支持 <code v-pre>addGlobalClass</code> 选项，即在 Component 的 <code v-pre>options</code> 中设置 <code v-pre>addGlobalClass: true</code>。 这个选项等价于设置 <code v-pre>styleIsolation: apply-shared</code> ，但设置了 <code v-pre>styleIsolation</code> 选项后这个选项会失效。</p>
<details class="hint-container details"><summary>代码示例</summary>
...
<h2 id="外部样式类" tabindex="-1"><a class="header-anchor" href="#外部样式类"><span>外部样式类 <Badge type="grey" text="高级" /></span></a></h2>
<p>有时，组件希望接受外部传入的样式类。此时可以在 Component 中用 <code v-pre>externalClasses</code> 定义段定义若干个外部样式类。</p>
...
<h2 id="引用页面或父组件的样式" tabindex="-1"><a class="header-anchor" href="#引用页面或父组件的样式"><span>引用页面或父组件的样式 <Badge type="grey" text="高级" /></span></a></h2>
<blockquote>
<p>基础库 2.9.2 开始支持</p>
</blockquote>
<p>即使启用了样式隔离 <code v-pre>isolated</code> ，组件仍然可以在局部引用组件所在页面的样式或父组件的样式。</p>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">}</span></span></code></pre>
</div><p>在这个组件中可以使用 <code v-pre>~</code> 来引用这个类的样式:</p>
...
</div><p>也可以连续使用多个 <code v-pre>^</code> 来引用祖先组件中的样式。</p>
<div class="hint-container warning">
<p class="hint-container-title">注意</p>
<p>如果组件是比较独立、通用的组件，请优先使用外部样式类的方式，而非直接引用父组件或页面的样式。</p>
</div>
<h2 id="虚拟化组件节点" tabindex="-1"><a class="header-anchor" href="#虚拟化组件节点"><span>虚拟化组件节点 <Badge type="grey" text="高级" /></span></a></h2>
<blockquote>
<p>基础库 2.11.2 开始支持</p>
</blockquote>
...
<ul>
<li>将 style 定义成 <code v-pre>properties</code> 属性来获取 style 上设置的值；</li>
<li>将 class 定义成 <code v-pre>externalClasses</code> 外部样式类使得自定义组件 wxml 可以使用 class 值。</li>
</ul>
