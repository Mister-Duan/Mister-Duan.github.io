<template><div><p>这里是开发前应当了解的内容，阅读时长大约为五分钟。</p>
<h2 id="json-文件中合法的值有哪些" tabindex="-1"><a class="header-anchor" href="#json-文件中合法的值有哪些"><span>json 文件中合法的值有哪些</span></a></h2>
<p>合法的值大家编辑用到的一共有五种:
...
<h2 id="json-介绍" tabindex="-1"><a class="header-anchor" href="#json-介绍"><span>json 介绍</span></a></h2>
<h3 id="对象" tabindex="-1"><a class="header-anchor" href="#对象"><span>对象</span></a></h3>
...
</div><p>Yaml 也允许另一种写法，将所有键值对写成一个行内对象。</p>
...
</div><h3 id="数组" tabindex="-1"><a class="header-anchor" href="#数组"><span>数组</span></a></h3>
...
</div><p>数据结构的子成员是一个数组，则可以在该项下面缩进一个空格。</p>
<div class="language-yml" data-highlighter="shiki" data-ext="yml" data-title="yml" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">- - </span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379">Cat</span></span>
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">  - </span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379">Dog</span></span>
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">  - </span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379">Goldfish</span></span></code></pre>
</div><p>转为 JavaScript 如下。</p>
<div class="language-js" data-highlighter="shiki" data-ext="js" data-title="js" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">[[</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379">"Cat"</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">, </span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379">"Dog"</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">, </span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379">"Goldfish"</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">]];</span></span></code></pre>
</div><p>数组也可以采用行内表示法。</p>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">}</span></span></code></pre>
</div><h3 id="复合结构" tabindex="-1"><a class="header-anchor" href="#复合结构"><span>复合结构</span></a></h3>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">    },</span></span>
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">}</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="纯量" tabindex="-1"><a class="header-anchor" href="#纯量"><span>纯量</span></a></h3>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">}</span></span></code></pre>
</div><p>布尔值用 <code v-pre>true</code> 和 <code v-pre>false</code> 表示。</p>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">}</span></span></code></pre>
</div><h3 id="如何打开或编辑-json" tabindex="-1"><a class="header-anchor" href="#如何打开或编辑-json"><span>如何打开或编辑 json</span></a></h3>
<p>推荐使用 VS Code，具体详见<RouteLink to="/software/vscode/simple.html">VS Code 简单介绍</RouteLink>。</p>
<h3 id="json-中的值" tabindex="-1"><a class="header-anchor" href="#json-中的值"><span>json 中的值</span></a></h3>
...
<h3 id="什么是number" tabindex="-1"><a class="header-anchor" href="#什么是number"><span>什么是<strong>number</strong></span></a></h3>
...
<h3 id="什么是boolean" tabindex="-1"><a class="header-anchor" href="#什么是boolean"><span>什么是<strong>boolean</strong></span></a></h3>
<p><strong>boolean</strong>是布尔值，表示真假。只有两个: <code v-pre>true</code> 和 <code v-pre>false</code>。</p>
<h3 id="什么是string" tabindex="-1"><a class="header-anchor" href="#什么是string"><span>什么是<strong>string</strong></span></a></h3>
...
<p><strong>请注意:</strong> <code v-pre>1</code> 是 <strong>number</strong>，可以参加运算；<code v-pre>&quot;1&quot;</code> 是<strong>string</strong>，字符串内容为 1；同理，<code v-pre>&quot;true&quot;</code> 是<strong>string</strong>，<code v-pre>true</code> 才是表示“真”的 <strong>boolean</strong>。</p>
<p><strong>其他注意事项:</strong> 如果想要在字符串中表示回车，请输入 <code v-pre>\n</code>。</p>
<h3 id="什么是array" tabindex="-1"><a class="header-anchor" href="#什么是array"><span>什么是<strong>array</strong></span></a></h3>
<p>Array 中文名叫数组，它是用 <code v-pre>[</code> <code v-pre>]</code> 包括起来的、用英文逗号(comma)分隔开的内容的集合，每个项叫数组(array)的一个元素(element)。每个元素(element)可以是其他的任何值类型。</p>
<p><strong>例</strong>:</p>
<ul>
...
<ul>
<li><code v-pre>[1,2,3,]</code> 是非法的，因为最后多了一个逗号导致格式不正确</li>
<li><code v-pre>[1,2,3</code> 也是非法的，因为没有结束标识符 <code v-pre>]</code> 导致格式不正确</li>
</ul>
</div>
<p><strong>总结</strong>:</p>
<p><strong>array</strong> 是一个包含若干 <strong>元素</strong> 的集合，用 <code v-pre>[</code> <code v-pre>]</code> 表示，每一个 <strong>元素</strong> 之间需要用 <strong>英文逗号</strong> 隔开，即 <code v-pre>array = [element1 , element2 , ...]</code>，其中<strong>元素</strong>可以是其他数据类型。</p>
<h3 id="什么是object" tabindex="-1"><a class="header-anchor" href="#什么是object"><span>什么是<strong>object</strong></span></a></h3>
<p><strong>object</strong> 中文名叫对象(不是您想的那个对象)，它是用 <code v-pre>{</code> <code v-pre>}</code> 包括起来的用逗号分隔开的一堆属性(property)的集合，每个属性(property)是一个不可重复的字符串，对应着一个值(value)，用冒号对应。该值(value)可以是任何内容。</p>
<p><strong>例</strong>:</p>
<ul>
<li>
<p><code v-pre>{&quot;a&quot;:1,&quot;b&quot;:&quot;2&quot;,&quot;c&quot;:true,&quot;d&quot;:&quot;false&quot;}</code></p>
<p>该对象有四项，分别是:</p>
<ul>
<li>值为数字 <code v-pre>1</code> 的 <code v-pre>a</code></li>
<li>值为字符串 <code v-pre>2</code> 的 <code v-pre>b</code></li>
<li>值为布尔值 真(<code v-pre>true</code>)的 <code v-pre>c</code></li>
<li>值为字符串 <code v-pre>false</code> 的 <code v-pre>d</code></li>
</ul>
</li>
<li>
<p><code v-pre>{&quot;tag&quot;:&quot;p&quot;,&quot;head&quot;:&quot;校园卡说明&quot;,&quot;text&quot;:&quot;校园卡是东师的金融消费卡&quot;}</code>。</p>
</li>
</ul>
<div class="hint-container warning">
<p class="hint-container-title">注意</p>
<ul>
<li><code v-pre>{a:1,b:2}</code> 是非法的，因为属性不是一个字符串</li>
<li><code v-pre>{&quot;a&quot;:1,&quot;a&quot;:2}</code> 是非法的，因为属性 <code v-pre>a</code> 出现了两次无法确定其值</li>
<li><code v-pre>{a:1,b:2,}</code>、<code v-pre>a:1,b:2}</code> 是非法的，因为格式不正确。</li>
</ul>
</div>
<p><strong>总结</strong>:</p>
<p><strong>object</strong>是一个拥有若干<strong>property</strong>的集合，用 <code v-pre>{</code> <code v-pre>}</code> 表示，每一个<strong>property</strong>都是不可重复的<strong>string</strong>，而每个<strong>property</strong>对应着一个<strong>value</strong>即 <code v-pre>object = { property1 : value1 , proprety2 : value2 , ... }</code>，其中<strong>value</strong>可以是其他数据类型。</p>
