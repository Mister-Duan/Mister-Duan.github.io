<template><div><p><strong>媒体查询</strong> (Media queries) 非常实用，尤其是当您想要根据设备的大致类型 (如打印设备与带屏幕的设备) 或者特定的特征和设备参数 (例如屏幕分辨率和浏览器视窗宽度) 来修改网站或应用程序时。</p>
<!-- more -->
<p>媒体查询常被用于以下目的:</p>
<ul>
<li>
<p>有条件的通过 <code v-pre>@media</code> 和 <code v-pre>@import</code> 用 CSS 装饰样式。</p>
</li>
<li>
<p>用 <code v-pre>media=</code> 属性为 <code v-pre>&lt;style&gt;</code>, <code v-pre>&lt;link&gt;</code>, <code v-pre>&lt;source&gt;</code> 和其他 HTML 元素指定特定的媒体类型。如:</p>
...
<li>
<p>使用 <code v-pre>Window.matchMedia()</code> 和 <code v-pre>MediaQueryList.addListener()</code> 方法来测试和监控媒体状态。</p>
</li>
</ul>
...
<p>当媒体类型(如果指定)与在其上显示文档的设备匹配并且所有媒体功能表达式都计算为 <code v-pre>true</code> 时，媒体查询将计算为 <code v-pre>true</code>。涉及未知媒体类型的查询始终为 <code v-pre>false</code>。</p>
<div class="hint-container warning">
<p class="hint-container-title">注意</p>
<p>有媒体查询附加到其 <code v-pre>&lt;link&gt;</code> 的样式表在媒体查询返回 <code v-pre>false</code> 时也会下载。只有查询结果变为 <code v-pre>true</code> 时才会应用内容。</p>
</div>
<h3 id="媒体类型" tabindex="-1"><a class="header-anchor" href="#媒体类型"><span>媒体类型</span></a></h3>
<p>媒体类型(Media types)描述设备的一般类别。除非使用 <code v-pre>not</code> 或 <code v-pre>only</code> 逻辑操作符，媒体类型是可选的，并且会(隐式地)应用 <code v-pre>all</code> 类型。</p>
<ul>
...
<h3 id="媒体特性" tabindex="-1"><a class="header-anchor" href="#媒体特性"><span>媒体特性</span></a></h3>
...
| width                        | 视窗(viewport)的宽度，包括纵向滚动条的宽度                                                 |                                     |</p>
<h3 id="逻辑操作符" tabindex="-1"><a class="header-anchor" href="#逻辑操作符"><span>逻辑操作符</span></a></h3>
<p>逻辑操作符(logical operators) <code v-pre>not</code>, <code v-pre>and</code>, 和 <code v-pre>only</code> 可用于联合构造复杂的媒体查询，您还可以通过用逗号分隔多个媒体查询，将它们组合为一个规则。</p>
<h4 id="and" tabindex="-1"><a class="header-anchor" href="#and"><span>and</span></a></h4>
<p><code v-pre>and</code> 操作符用于将多个媒体查询规则组合成单条媒体查询，当每个查询规则都为真时则该条媒体查询为真，它还用于将媒体功能与媒体类型结合在一起。</p>
<h4 id="not" tabindex="-1"><a class="header-anchor" href="#not"><span>not</span></a></h4>
<p><code v-pre>not</code> 运算符用于否定媒体查询，如果不满足这个条件则返回 <code v-pre>true</code>，否则返回 <code v-pre>false</code>。如果出现在以逗号分隔的查询列表中，它将仅否定应用了该查询的特定查询。如果使用 <code v-pre>not</code> 运算符，则还必须指定媒体类型。</p>
<h4 id="only" tabindex="-1"><a class="header-anchor" href="#only"><span>only</span></a></h4>
<p><code v-pre>only</code> 运算符仅在整个查询匹配时才用于应用样式，并且对于防止较早的浏览器应用所选样式很有用。当不使用 <code v-pre>only</code> 时，旧版本的浏览器会将 <code v-pre>screen and (max-width: 500px)</code> 简单地解释为 <code v-pre>screen</code>，忽略查询的其余部分，并将其样式应用于所有屏幕。如果使用 <code v-pre>only</code> 运算符，则还必须指定媒体类型。</p>
<h4 id="逗号" tabindex="-1"><a class="header-anchor" href="#逗号"><span>, (逗号)</span></a></h4>
<p>逗号用于将多个媒体查询合并为一个规则。逗号分隔列表中的每个查询都与其他查询分开处理。因此，如果列表中的任何查询为 true，则整个 media 语句均返回 true。换句话说，列表的行为类似于逻辑或 or 运算符。</p>
<h2 id="定位媒体类型" tabindex="-1"><a class="header-anchor" href="#定位媒体类型"><span>定位媒体类型</span></a></h2>
...
</div><p>您还可以定位多个设备。例如，此 <code v-pre>@media</code> 规则使用两个媒体查询来同时定位屏幕和打印设备</p>
...
<span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD">  ..</span><span style="--shiki-light:white;--shiki-dark:#FFFFFF">.;</span></span>
<span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD">}</span></span></code></pre>
</div><h2 id="定位媒体特性" tabindex="-1"><a class="header-anchor" href="#定位媒体特性"><span>定位媒体特性</span></a></h2>
...
<span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD">  ..</span><span style="--shiki-light:white;--shiki-dark:#FFFFFF">.;</span></span>
<span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD">}</span></span></code></pre>
</div><p>许多媒体功能都是范围功能，这意味着可以在它们前面加上“最小”或“最大”来表示“最小条件”或“最大条件”约束。例如，仅当您的浏览器的 viewport 宽度等于或小于 12450px 时，此 CSS 才会应用样式:</p>
...
<span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD">  ..</span><span style="--shiki-light:white;--shiki-dark:#FFFFFF">.;</span></span>
<span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD">}</span></span></code></pre>
</div><p>如果您在未指定值的情况下创建媒体功能查询，则该样式将全部被应用，只要该查询的值不为零即可。例如，此 CSS 将适用于任何带有彩色屏幕的设备:</p>
...
<span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD">  ..</span><span style="--shiki-light:white;--shiki-dark:#FFFFFF">.;</span></span>
<span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD">}</span></span></code></pre>
</div><p>如果某个功能不适用于运行浏览器的设备，则涉及该媒体功能的表达式始终为 <code v-pre>false</code>。例如，将不会使用嵌套在以下查询中的样式，因为没有语音专用设备具有屏幕长宽比:</p>
...
<span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD">  ..</span><span style="--shiki-light:white;--shiki-dark:#FFFFFF">.;</span></span>
<span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD">}</span></span></code></pre>
</div><h2 id="创建复杂查询" tabindex="-1"><a class="header-anchor" href="#创建复杂查询"><span>创建复杂查询</span></a></h2>
<p>有时您可能想创建一个取决于多个条件的媒体查询。这就是逻辑运算符使用的场景: <code v-pre>not</code>，<code v-pre>and</code>，和 <code v-pre>only</code>。此外，您可以将多个媒体查询合并到一个逗号分隔的列表中。这使您可以在不同情况下应用相同的样式。</p>
<p>在前面的示例中，我们已经看到 <code v-pre>and</code> 运算符用于将媒体类型与媒体功能分组。<code v-pre>and</code> 运算符还可以将多个媒体功能组合到单个媒体查询中。同时， <code v-pre>not</code> 运算符会否定媒体查询，从而基本上颠倒了它的正常含义。唯一的运算符可防止较早的浏览器应用样式。</p>
<div class="hint-container warning">
<p class="hint-container-title">注意</p>
<p>在大多数情况下，默认情况下，如果未指定其他类型，则使用 <code v-pre>all</code> 媒体类型。但是，如果使用 <code v-pre>not</code> 或 <code v-pre>only</code> 运算符，则必须显式指定媒体类型。</p>
</div>
<h3 id="结合多种类型和特性" tabindex="-1"><a class="header-anchor" href="#结合多种类型和特性"><span>结合多种类型和特性</span></a></h3>
<p><code v-pre>and</code> 关键字将媒体功能与媒体类型或其他媒体功能组合在一起。此示例结合了两种媒体功能，以将样式限制为宽度至少为 30em 的横向的设备:</p>
...
<span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD">  ..</span><span style="--shiki-light:white;--shiki-dark:#FFFFFF">.;</span></span>
<span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD">}</span></span></code></pre>
</div><p>要将样式限制为带有屏幕的设备，可以将媒体功能链接到 screen 媒体类型:</p>
...
<span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD">  ..</span><span style="--shiki-light:white;--shiki-dark:#FFFFFF">.;</span></span>
<span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD">}</span></span></code></pre>
</div><h3 id="测试多重查询" tabindex="-1"><a class="header-anchor" href="#测试多重查询"><span>测试多重查询</span></a></h3>
...
<span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD">  ..</span><span style="--shiki-light:white;--shiki-dark:#FFFFFF">.;</span></span>
<span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD">}</span></span></code></pre>
</div><p>以上面的示例为例，如果用户使用的打印机的页面高度为 800 像素，则 media 语句将返回 <code v-pre>true</code>，因为将应用第一个查询。同样，如果用户使用的是纵向模式的智能手机，并且视口高度为 480px，则将应用第二个查询，并且 media 语句仍将返回 <code v-pre>true</code>。</p>
<h3 id="反转查询的含义" tabindex="-1"><a class="header-anchor" href="#反转查询的含义"><span>反转查询的含义</span></a></h3>
<p><code v-pre>not</code> 关键字会反转整个媒体查询的含义。它只会否定要应用的特定媒体查询。(因此，它不会应用于以逗号分隔的媒体查询列表中的每个媒体查询。)<code v-pre>not</code> 关键字不能用于否定单个功能查询，只能用于否定整个媒体查询。看看以下 <code v-pre>not</code> 关键字的例子:</p>
...
<span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD">  ..</span><span style="--shiki-light:white;--shiki-dark:#FFFFFF">.;</span></span>
<span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD">}</span></span></code></pre>
</div><h3 id="提升老版本浏览器兼容性" tabindex="-1"><a class="header-anchor" href="#提升老版本浏览器兼容性"><span>提升老版本浏览器兼容性</span></a></h3>
<p><code v-pre>only</code> 关键字可防止不支持带有媒体功能的媒体查询的旧版浏览器应用给定的样式。它对现代浏览器没有影响。</p>
...
<span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD">  ..</span><span style="--shiki-light:white;--shiki-dark:#FFFFFF">.;</span></span>
<span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD">}</span></span></code></pre>
</div><h2 id="版本-4-中的语法改进" tabindex="-1"><a class="header-anchor" href="#版本-4-中的语法改进"><span>版本 4 中的语法改进</span></a></h2>
<p>媒体查询 4 级规范对语法进行了一些改进，以使用具有“范围”类型(例如宽度或高度，减少冗余)的功能进行媒体查询。级别 4 添加了用于编写此类的查询范围上下文。例如，使用最大宽度 <code v-pre>max-</code> 功能，我们可以编写以下代码:</p>
...
<span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD">  ..</span><span style="--shiki-light:white;--shiki-dark:#FFFFFF">.;</span></span>
<span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD">}</span></span></code></pre>
</div><p>使用 <code v-pre>min-</code> 和 <code v-pre>max-</code> 可以测试一个在两个值之间的宽度</p>
...
<span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD">  ..</span><span style="--shiki-light:white;--shiki-dark:#FFFFFF">.;</span></span>
<span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD">}</span></span></code></pre>
</div><p>媒体查询 4 级规范还添加了用 <code v-pre>and</code>, <code v-pre>not</code>, 和 <code v-pre>or</code> 实现的完整的布尔运算来合并媒体查询的方法。</p>
<h3 id="使用-not-否定一个特性" tabindex="-1"><a class="header-anchor" href="#使用-not-否定一个特性"><span>使用 <code v-pre>not</code> 否定一个特性</span></a></h3>
<p>在媒体功能周围使用 <code v-pre>not()</code> 会否定查询中的该特性。例如，如果设备没有悬停功能，则 <code v-pre>not(hover)</code> 将被匹配:</p>
...
<span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD">  ..</span><span style="--shiki-light:white;--shiki-dark:#FFFFFF">.;</span></span>
<span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD">}</span></span></code></pre>
</div><h3 id="用-or-测试多个特性" tabindex="-1"><a class="header-anchor" href="#用-or-测试多个特性"><span>用 <code v-pre>or</code> 测试多个特性</span></a></h3>
<p>您可以使用 <code v-pre>or</code> 测试多个功能之间的匹配，如果任何功能为 <code v-pre>true</code>，则解析为 <code v-pre>true</code>。例如，以下查询测试具有单色显示或悬停功能的设备:</p>
