...
<p>HTML5 标准推出了 <code v-pre>&lt;video&gt;</code> 和 <code v-pre>&lt;audio&gt;</code> 标签，以及一些 JavaScript 和 APIs 用于对其进行控制。</p>
<h2 id="video-元素" tabindex="-1"><a class="header-anchor" href="#video-元素"><span><code v-pre>&lt;video&gt;</code> 元素</span></a></h2>
<p><code v-pre>&lt;video&gt;</code> 允许您轻松地嵌入一段视频。</p>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">  &#x3C;/</span><span style="--shiki-light:#E45649;--shiki-dark:#E06C75">p</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">></span></span>
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">&#x3C;/</span><span style="--shiki-light:#E45649;--shiki-dark:#E06C75">video</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">></span></span></code></pre>
</div></div>
<p>案例属性解释:</p>
<ul>
<li>
<p>src</p>
<p>同 <code v-pre>&lt;img&gt;</code> 标签使用方式相同，<code v-pre>src</code> 属性指向您想要嵌入网页当中的视频资源，他们的使用方式完全相同。</p>
</li>
<li>
<p>controls</p>
<p>用户必须能够控制视频和音频的回放功能。您可以使用 <code v-pre>controls</code> 来包含浏览器提供的控件界面，同时您也可以使用合适的 JavaScript API 创建自己的界面。界面中至少要包含开始、停止以及调整音量的功能。</p>
</li>
<li>
<p><code v-pre>&lt;video&gt;</code> 标签内的内容</p>
<p>此内容叫后备内容。当浏览器不支持 <code v-pre>&lt;video&gt;</code> 标签的时候，就会显示这段内容，这使得我们能够对旧的浏览器提供回退内容。您可以添加任何后备内容，在这个例子中我们提供了一个指向这个视频文件的链接，从而使用户至少可以访问到这个文件，而不会局限于浏览器的支持。</p>
</li>
</ul>
<h3 id="兼容性" tabindex="-1"><a class="header-anchor" href="#兼容性"><span>兼容性</span></a></h3>
<p>如果您使用 Safari 或者 IE 来访问上面的链接，视频并不会播放，这是因为不同的浏览器对视频格式的支持不同。</p>
<p>所以 <code v-pre>&lt;video&gt;</code> 标签的最佳实践是使用多个播放源以提高兼容性。</p>
<div class="hint-container tip">
<p class="hint-container-title">媒体文件的内容</p>
...
<p>另一种情况是一直流行的 MP3 文件。“MP3 文件”实际上是存储在 MPEG 或 MPEG-2 容器中的 MPEG-1 音频层 III(MPEG-1 Audio Layer III ，MP3)音频轨道。这一点特别有趣，因为尽管大多数浏览器不支持在 <code v-pre>&lt;video&gt;</code> 和 <code v-pre>&lt;audio&gt;</code> 元素中使用 MPEG 媒体，但由于 MP3 的流行，它们可能仍然支持 MP3。</p>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">  &#x3C;/</span><span style="--shiki-light:#E45649;--shiki-dark:#E06C75">p</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">></span></span>
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">&#x3C;/</span><span style="--shiki-light:#E45649;--shiki-dark:#E06C75">video</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">></span></span></code></pre>
</div><p>您需要将 <code v-pre>src</code> 属性从 <code v-pre>&lt;video&gt;</code> 标签中移除，转而将它放在几个单独的标签 <code v-pre>&lt;source&gt;</code> 当中。浏览器将会检查 <code v-pre>&lt;source&gt;</code> 标签，并且播放第一个与其自身 codec 相匹配的媒体。</p>
<div class="hint-container tip">
<p class="hint-container-title">提示</p>
<p>您的视频应当包括 WebM 和 MP4 两种格式，这两种在目前已经足够支持大多数平台和浏览器。</p>
</div>
<p>每个 <code v-pre>&lt;source&gt;</code> 标签页含有一个 <code v-pre>type</code> 属性，这个属性是可选的，但是建议您添加上这个属性 — 它包含了视频文件的 <RouteLink to="/code/website/definition/mime.html">MIME types</RouteLink> ，同时浏览器也会通过检查这个属性来迅速的跳过那些不支持的格式。如果您没有添加 <code v-pre>type</code> 属性，浏览器会尝试加载每一个文件，直到找到一个能正确播放的格式，这样会消耗掉大量的时间和资源。</p>
<h3 id="其他属性" tabindex="-1"><a class="header-anchor" href="#其他属性"><span>其他属性</span></a></h3>
<p>这里有许多您可以用在 HTML5 <code v-pre>&lt;video&gt;</code> 上的特性。</p>
...
<ul>
<li><code v-pre>none</code>: 不缓冲</li>
<li><code v-pre>auto</code>: 页面加载后缓存媒体文件</li>
<li><code v-pre>metadata</code>: 仅缓冲文件的元数据</li>
</ul>
</li>
</ul>
<h2 id="audio-标签" tabindex="-1"><a class="header-anchor" href="#audio-标签"><span><code v-pre>&lt;audio&gt;</code> 标签</span></a></h2>
<p><code v-pre>&lt;audio&gt;</code> 标签与 <code v-pre>&lt;video&gt;</code> 标签的使用方式几乎完全相同，有一些细微的差别。</p>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">&#x3C;/</span><span style="--shiki-light:#E45649;--shiki-dark:#E06C75">audio</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">></span></span></code></pre>
</div><p>音频播放器所占用的空间比视频播放器要小，由于它没有视觉部件 — 您只需要显示出能控制音频播放的控件。一些与 HTML5 <code v-pre>&lt;video&gt;</code> 的差异如下:</p>
<ul>
<li><code v-pre>&lt;audio&gt;</code> 标签不支持 <code v-pre>width/height</code> 属性 — 由于其并没有视觉部件，也就没有可以设置 <code v-pre>width/height</code> 的内容。</li>
<li>同时也不支持 <code v-pre>poster</code> 属性 — 同样，没有视觉部件。</li>
</ul>
<p>除此之外，<code v-pre>&lt;audio&gt;</code> 标签支持所有 <code v-pre>&lt;video&gt;</code> 标签拥有的特性。</p>
<h2 id="显示音轨文本" tabindex="-1"><a class="header-anchor" href="#显示音轨文本"><span>显示音轨文本</span></a></h2>
<p>文本轨道会使您的网站更容易被搜索引擎抓取到 (SEO)， 由于搜索引擎的文本抓取能力非常强大，使用文本轨道甚至可以让搜索引擎通过视频的内容直接链接。</p>
<div class="hint-container info">
<p class="hint-container-title">WebVTT</p>
...
<div class="language-txt line-numbers-mode" data-highlighter="shiki" data-ext="txt" data-title="example.vtt" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>WEBVTT</span></span>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></div>
<p>有了 WebVTT 格式，您可以使用 <code v-pre>&lt;track&gt;</code> 标签。</p>
<p>让其与 HTML 媒体一起显示，您需要做如下工作:</p>
<ol>
<li>以 <code v-pre>.vtt</code> 后缀名保存文件。</li>
<li>用 <code v-pre>&lt;track&gt;</code> 标签链接 <code v-pre>.vtt</code> 文件， <code v-pre>&lt;track&gt;</code> 标签需放在 <code v-pre>&lt;audio&gt;</code> 或 <code v-pre>&lt;video&gt;</code> 标签当中，同时需要放在所有 <code v-pre>&lt;source&gt;</code> 标签之后。使用 <code v-pre>kind</code> 属性来指明是哪一种类型，如 <code v-pre>subtitles</code> 、 <code v-pre>captions</code> 、 <code v-pre>descriptions</code>。然后，使用 <code v-pre>srclang</code> 来告诉浏览器您是用什么语言来编写的 subtitles。</li>
</ol>
<div class="hint-container tip">
<p class="hint-container-title">案例</p>
<div class="language-html" data-highlighter="shiki" data-ext="html" data-title="html" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">&#x3C;</span><span style="--shiki-light:#E45649;--shiki-dark:#E06C75">video</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66"> controls</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">></span></span>
