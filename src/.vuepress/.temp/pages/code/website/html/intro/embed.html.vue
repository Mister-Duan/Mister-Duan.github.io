<template><div><h2 id="iframe" tabindex="-1"><a class="header-anchor" href="#iframe"><span>Iframe</span></a></h2>
<p><code v-pre>&lt;iframe&gt;</code> 元素旨在允许您将其他 Web 文档嵌入到当前文档中。这很适合将第三方内容嵌入您的网站，您可能无法直接控制，也不希望实现自己的版本 - 例如来自在线视频提供商的视频，Disqus 等评论系统，在线地图提供商，广告横幅等。</p>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">  &#x3C;/</span><span style="--shiki-light:#E45649;--shiki-dark:#E06C75">p</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">></span></span>
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">&#x3C;/</span><span style="--shiki-light:#E45649;--shiki-dark:#E06C75">iframe</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">></span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></div>
<ul>
<li>
<p>allowfullscreen</p>
<p>如果设置，<code v-pre>&lt;iframe&gt;</code> 则可以通过全屏 API 设置为全屏模式(稍微超出本文的范围)。</p>
</li>
<li>
<p>frameborder</p>
...
<li>
<p>src</p>
<p>该属性与 <code v-pre>&lt;video&gt;/&lt;img&gt;</code> 一样包含指向要嵌入文档的 URL 路径。</p>
</li>
<li>
<p>width 和 height</p>
...
<li>
<p>备选内容
与 <code v-pre>&lt;video&gt;</code> 等其他类似元素相同，您可以在 <code v-pre>&lt;iframe&gt;&lt;/iframe&gt;</code> 标签之间包含备选内容，如果浏览器不支持 <code v-pre>&lt;iframe&gt;</code>，将会显示备选内容，这种情况下，我们已经添加了一个到该页面的链接。</p>
<div class="hint-container tip">
<p class="hint-container-title">提示</p>
<p>2023 年几乎不可能遇到不支持 <code v-pre>&lt;iframe&gt;</code> 的浏览器。</p>
</div>
</li>
<li>
<p>sandbox</p>
<p>该属性需要在已经支持其他 <code v-pre>&lt;iframe&gt;</code> 功能(例如 IE 10 及更高版本)但稍微更现代的浏览器上才能工作，该属性可以提高安全性设置。</p>
</li>
</ul>
<h3 id="安全隐患" tabindex="-1"><a class="header-anchor" href="#安全隐患"><span>安全隐患</span></a></h3>
<p>如果黑客试图恶意修改您的网页或欺骗人们进行不想做的事情时常把 iframe 作为共同的攻击目标(官方术语: 攻击向量)，例如显示用户名和密码等敏感信息。因此，规范工程师和浏览器开发人员已经开发了各种安全机制，使 <code v-pre>&lt;iframe&gt;</code> 更加安全。</p>
<div class="hint-container tip">
<p class="hint-container-title">提示</p>
<p>单击劫持是一种常见的 iframe 攻击，黑客将隐藏的 iframe 嵌入到您的文档中(或将您的文档嵌入到他们自己的恶意网站)，并使用它来捕获用户的交互。这是误导用户或窃取敏感数据的常见方式。</p>
</div>
<h4 id="只有在必要时嵌入" tabindex="-1"><a class="header-anchor" href="#只有在必要时嵌入"><span>只有在必要时嵌入</span></a></h4>
...
<h4 id="使用-https" tabindex="-1"><a class="header-anchor" href="#使用-https"><span>使用 HTTPS</span></a></h4>
...
<h4 id="始终使用-sandbox-属性" tabindex="-1"><a class="header-anchor" href="#始终使用-sandbox-属性"><span>始终使用 sandbox 属性</span></a></h4>
<p>您应该给嵌入的内容仅能完成自己工作的权限，当然这也适用于您自己的内容。</p>
<p>一个允许包含在其里的代码以适当的方式执行或者用于测试，但不能对其他代码库(意外或恶意)造成任何损害的容器称为沙盒。</p>
<p>未沙盒化 (Unsandboxed) 内容可以做得太多，如执行 JavaScript，提交表单，弹出窗口等。默认情况下，您应该使用没有参数的 <code v-pre>sandbox</code> 属性来强制执行所有可用的限制，如我们前面的示例所示。如果真的需要关闭某些限制，您可以逐个添加权限(在 <code v-pre>sandbox=&quot;&quot;</code> 属性值内)。</p>
<div class="hint-container caution">
<p class="hint-container-title">警告</p>
<p>您永远不应该同时添加 <code v-pre>allow-scripts</code> 和 <code v-pre>allow-same-origin</code> 到您的 sandbox 属性中-在这种情况下，嵌入式内容可以绕过阻止站点执行脚本的同源安全策略，并使用 JavaScript 完全关闭沙盒。</p>
</div>
...
<h4 id="配置-csp-指令" tabindex="-1"><a class="header-anchor" href="#配置-csp-指令"><span>配置 CSP 指令</span></a></h4>
<p>CSP 代表内容安全策略，它提供一组 HTTP 标头(由 web 服务器发送时与元数据一起发送的元数据)，旨在提高 HTML 文档的安全性。在 <code v-pre>&lt;iframe&gt;</code> 安全性方面，您可以将服务器配置为发送适当的 <code v-pre>X-Frame-Options</code> 标题。这样做可以防止其他网站在其网页中嵌入您的内容(这将导致点击和一系列其他攻击)。</p>
<h2 id="embed-和-object" tabindex="-1"><a class="header-anchor" href="#embed-和-object"><span><code v-pre>&lt;embed&gt;</code> 和 <code v-pre>&lt;object&gt;</code></span></a></h2>
<p><code v-pre>&lt;embed&gt;</code> 和 <code v-pre>&lt;object&gt;</code> 元素的功能不同于 <code v-pre>&lt;iframe&gt;</code>。这些元素是用来嵌入多种类型的外部内容的通用嵌入工具，其中包括像 Java 小程序，PDF 这样的插件技术，甚至像视频，SVG 和图像的内容。</p>
<div class="hint-container warning">
<p class="hint-container-title">注意</p>
