<template><div><p>Personal Access Token (PAT)，又称个人访问令牌，是一种代替密码进行 GitHub 身份认证的方式。</p>
<p>通常情况下，你可能需要在 GitHub Workflow 中使用 PAT，以便在 GitHub Actions 中使用需要授权的 GitHub API。</p>
<!-- more -->
<h2 id="创建个人访问令牌" tabindex="-1"><a class="header-anchor" href="#创建个人访问令牌"><span>创建个人访问令牌</span></a></h2>
<ol>
<li>
