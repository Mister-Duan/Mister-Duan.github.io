<template><div><p>本文介绍如何利用 Git 和 GitHub Action，自动部署代码到服务器。</p>
<!-- more -->
<div class="hint-container tip">
<p class="hint-container-title">提示</p>
<p>由于 Centos 仍然是用 GitV1，本教程使用 Ubuntu 20.04 进行教学。</p>
</div>
<h2 id="服务器" tabindex="-1"><a class="header-anchor" href="#服务器"><span>服务器</span></a></h2>
<p>为了能供自动部署到服务器，我们需要让服务器的网站目录成为一个 Git 仓库，这样我们可以在 GitHub Actions 中，通过向服务器对应 GitHub 仓库推送网站内容，使服务器网站获得自动更新。下面是服务器侧的部署配置</p>
<h3 id="添加账户" tabindex="-1"><a class="header-anchor" href="#添加账户"><span>添加账户</span></a></h3>
...
</div><p>然后将部署目录的权限设置为 <code v-pre>775</code>，即允许同组访问。这样 git 就有权限访问部署目录。</p>
<h3 id="添加权限" tabindex="-1"><a class="header-anchor" href="#添加权限"><span>添加权限</span></a></h3>
<p>创建 <code v-pre>~/.ssh/</code> 文件夹，生成 <code v-pre>authorized_keys</code> 文件，并设置其权限为 <code v-pre>600</code>。</p>
...
<h3 id="创建仓库" tabindex="-1"><a class="header-anchor" href="#创建仓库"><span>创建仓库</span></a></h3>
<p>回到 <code v-pre>/home/git/</code>，创建所需的文件夹:</p>
...
</div><p>这会将 git 库保持在 <code v-pre>/home/git/&lt;仓库名&gt;</code> 下，同时将工作区设置到部署文件夹中。</p>
<p>接下来执行:</p>
...
<h2 id="github-actions" tabindex="-1"><a class="header-anchor" href="#github-actions"><span>GitHub Actions</span></a></h2>
...
<p>之后只需要使用 GitHub Action 通过 Git 推送到 <code v-pre>git@&lt;domain&gt;:&lt;部署目录&gt; gh-pages</code> 即可。</p>
