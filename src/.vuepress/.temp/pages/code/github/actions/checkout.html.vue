...
<p>个人访问令牌，又称 Personal access token (PAT)，用于配置机器 Git 配置，以运行需要身份验证的 Git 命令，详见 <RouteLink to="/code/github/token.html">GitHub Token</RouteLink>。</p>
<div v-pre>
<p>默认为工作流提供的 <code v-pre>${{ github.token }}</code></p>
</div>
<h3 id="fetch-depth" tabindex="-1"><a class="header-anchor" href="#fetch-depth"><span>fetch-depth</span></a></h3>
<p>要获取的提交数。 <code v-pre>0</code> 表示所有分支和标签的所有历史记录。</p>
<p>默认为 <code v-pre>1</code></p>
<h3 id="submodules" tabindex="-1"><a class="header-anchor" href="#submodules"><span>submodules</span></a></h3>
...
<h3 id="persist-credentials" tabindex="-1"><a class="header-anchor" href="#persist-credentials"><span>persist-credentials</span></a></h3>
...
<h3 id="ssh-known-hosts" tabindex="-1"><a class="header-anchor" href="#ssh-known-hosts"><span>ssh-known-hosts</span></a></h3>
<p>除了用户和全局主机密钥数据库外的已知主机。可以使用 <code v-pre>ssh-keyscan</code> 获得主机的公共 SSH 密钥。 例如，<code v-pre>ssh-keyscan github.com</code>。 github.com 的公钥总是隐式添加的。</p>
<div class="hint-container info">
<p class="hint-container-title">相关信息</p>
<p>当您需要获取其他代码托管商的仓库时，需要设置此选项</p>
</div>
<h3 id="ssh-strict" tabindex="-1"><a class="header-anchor" href="#ssh-strict"><span>ssh-strict</span></a></h3>
...
<h3 id="lfs" tabindex="-1"><a class="header-anchor" href="#lfs"><span>lfs</span></a></h3>
<p>是否下载 Git-LFS 文件。</p>
<p>默认为 <code v-pre>false</code></p>
