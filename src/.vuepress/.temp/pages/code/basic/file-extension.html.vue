<template><div><h2 id="文件名" tabindex="-1"><a class="header-anchor" href="#文件名"><span>文件名</span></a></h2>
<p>文件名就是文件的名称，是为了方便人们区分计算机中的不同文件，而给每个文件设定一个指定的名称。</p>
<p>文件名不能包含控制字符: <code v-pre>&lt;</code> <code v-pre>&gt;</code> <code v-pre>/</code> <code v-pre>\</code> <code v-pre>|</code> <code v-pre>:</code> <code v-pre>&quot;</code> <code v-pre>*</code> <code v-pre>?</code></p>
<h2 id="文件扩展名" tabindex="-1"><a class="header-anchor" href="#文件扩展名"><span>文件扩展名</span></a></h2>
