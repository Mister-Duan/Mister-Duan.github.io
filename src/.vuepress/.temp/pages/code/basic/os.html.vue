<template><div><p>操作系统 (Operating System，OS) 是软件的一部分，它是硬件基础上的第一层软件，是硬件和其它软件沟通的桥梁(或者说接口、中间人、中介等)。</p>
<!-- more -->
...
<figure><img src="@source/code/basic/assets/OS.gif" alt="操作系统结构示意图" tabindex="0" loading="lazy"><figcaption>操作系统结构示意图</figcaption></figure>
