<template><div><p>计算机是一台机器，它按照用户的要求接收信息、存储数据、处理数据，然后再将处理结果输出(文字、图片、音频、视频等)。</p>
...
<h2 id="组成" tabindex="-1"><a class="header-anchor" href="#组成"><span>组成</span></a></h2>
<p>计算机由硬件和软件组成。</p>
<h3 id="硬件" tabindex="-1"><a class="header-anchor" href="#硬件"><span>硬件</span></a></h3>
...
<h3 id="软件" tabindex="-1"><a class="header-anchor" href="#软件"><span>软件</span></a></h3>
