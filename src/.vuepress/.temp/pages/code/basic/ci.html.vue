<template><div><p>持续集成 (Continuous Integration) 指的是，频繁地 (一天多次) 将代码集成到主干，每次集成都通过自动化的构建 (包括编译，发布，自动化测试) 来验证，从而尽早地发现集成错误。</p>
...
<h3 id="要点" tabindex="-1"><a class="header-anchor" href="#要点"><span>要点</span></a></h3>
...
<h2 id="持续交付" tabindex="-1"><a class="header-anchor" href="#持续交付"><span>持续交付</span></a></h2>
...
<h2 id="持续部署" tabindex="-1"><a class="header-anchor" href="#持续部署"><span>持续部署</span></a></h2>
...
<p>Jenkins 和 Strider 是开源软件，GitHub Actions 是常用的线上构建工具。它们都会将构建和测试，在一次运行中执行完成。</p>
</li>
<li>
<p>测试 (第二轮)</p>
