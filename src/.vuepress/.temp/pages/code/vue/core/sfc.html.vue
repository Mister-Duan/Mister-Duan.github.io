...
<p>Vue 的单文件组件 (即 <code v-pre>*.vue</code> 文件，简称 <strong>SFC</strong>) 是一种特殊的文件格式，使我们能够将一个 Vue 组件的模板、逻辑与样式封装在单个文件中。下面是一个单文件组件的示例：</p>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如你所见，Vue 的单文件组件是 HTML、CSS 和 JavaScript 三种元素的自然延伸。<code v-pre>&lt;template&gt;</code>、<code v-pre>&lt;script&gt;</code> 和 <code v-pre>&lt;style&gt;</code> 三个块在同一个文件中封装、组合了组件的视图、逻辑和样式。</p>
<h2 id="总览" tabindex="-1"><a class="header-anchor" href="#总览"><span>总览</span></a></h2>
<h2 id="总览-overview" tabindex="-1"><a class="header-anchor" href="#总览-overview"><span>总览 {#overview}</span></a></h2>
<p>一个 Vue 单文件组件 (SFC)，通常使用 <code v-pre>*.vue</code> 作为文件扩展名，它是一种使用了类似 HTML 语法的自定义文件格式，用于定义 Vue 组件。一个 Vue 单文件组件在语法上是兼容 HTML 的。</p>
<p>每一个 <code v-pre>*.vue</code> 文件都由三种顶层语块构成：<code v-pre>&lt;template&gt;</code>、<code v-pre>&lt;script&gt;</code> 和 <code v-pre>&lt;style&gt;</code>，以及一些其他的自定义块：</p>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="相应语言块-language-blocks" tabindex="-1"><a class="header-anchor" href="#相应语言块-language-blocks"><span>相应语言块 {#language-blocks}</span></a></h2>
<h3 id="template-template" tabindex="-1"><a class="header-anchor" href="#template-template"><span><code v-pre>&lt;template&gt;</code> {#template}</span></a></h3>
<ul>
<li>
<p>每个 <code v-pre>*.vue</code> 文件最多可以包含一个顶层 <code v-pre>&lt;template&gt;</code> 块。</p>
</li>
<li>
<p>语块包裹的内容将会被提取、传递给 <code v-pre>@vue/compiler-dom</code>，预编译为 JavaScript 渲染函数，并附在导出的组件上作为其 <code v-pre>render</code> 选项。</p>
</li>
</ul>
<h3 id="script-script" tabindex="-1"><a class="header-anchor" href="#script-script"><span><code v-pre>&lt;script&gt;</code> {#script}</span></a></h3>
<ul>
<li>
<p>每个 <code v-pre>*.vue</code> 文件最多可以包含一个 <code v-pre>&lt;script&gt;</code> 块。(使用 <RouteLink to="/api/sfc-script-setup.html"><code v-pre>&lt;script setup&gt;</code></RouteLink> 的情况除外)</p>
</li>
<li>
<p>这个脚本代码块将作为 ES 模块执行。</p>
</li>
<li>
<p><strong>默认导出</strong>应该是 Vue 的组件选项对象，可以是一个对象字面量或是 <RouteLink to="/api/general.html#definecomponent">defineComponent</RouteLink> 函数的返回值。</p>
</li>
</ul>
<h3 id="script-setup-script-setup" tabindex="-1"><a class="header-anchor" href="#script-setup-script-setup"><span><code v-pre>&lt;script setup&gt;</code> {#script-setup}</span></a></h3>
<ul>
<li>
<p>每个 <code v-pre>*.vue</code> 文件最多可以包含一个 <code v-pre>&lt;script setup&gt;</code>。(不包括一般的 <code v-pre>&lt;script&gt;</code>)</p>
</li>
<li>
<p>这个脚本块将被预处理为组件的 <code v-pre>setup()</code> 函数，这意味着它将<strong>为每一个组件实例</strong>都执行。<code v-pre>&lt;script setup&gt;</code> 中的顶层绑定都将自动暴露给模板。要了解更多细节，请看 <a href="/api/sfc-script-setup"><code v-pre>&lt;script setup&gt;</code> 的专门文档</a>。</p>
</li>
</ul>
<h3 id="style-style" tabindex="-1"><a class="header-anchor" href="#style-style"><span><code v-pre>&lt;style&gt;</code> {#style}</span></a></h3>
<ul>
<li>
<p>每个 <code v-pre>*.vue</code> 文件可以包含多个 <code v-pre>&lt;style&gt;</code> 标签。</p>
</li>
<li>
<p>一个 <code v-pre>&lt;style&gt;</code> 标签可以使用 <code v-pre>scoped</code> 或 <code v-pre>module</code> attribute (查看 <a href="/api/sfc-css-features">SFC 样式功能</a>了解更多细节) 来帮助封装当前组件的样式。使用了不同封装模式的多个 <code v-pre>&lt;style&gt;</code> 标签可以被混合入同一个组件。</p>
</li>
</ul>
<h3 id="自定义块-custom-blocks" tabindex="-1"><a class="header-anchor" href="#自定义块-custom-blocks"><span>自定义块 {#custom-blocks}</span></a></h3>
<p>在一个 <code v-pre>*.vue</code> 文件中可以为任何项目特定需求使用额外的自定义块。举个例子，一个用作写文档的 <code v-pre>&lt;docs&gt;</code> 块。这里是一些自定义块的真实用例：</p>
<ul>
<li><a href="https://gridsome.org/docs/querying-data/" target="_blank" rel="noopener noreferrer">Gridsome：<code v-pre>&lt;page-query&gt;</code></a></li>
<li><a href="https://github.com/wheatjs/vite-plugin-vue-gql" target="_blank" rel="noopener noreferrer">vite-plugin-vue-gql：<code v-pre>&lt;gql&gt;</code></a></li>
<li><a href="https://github.com/intlify/bundle-tools/tree/main/packages/vite-plugin-vue-i18n#i18n-custom-block" target="_blank" rel="noopener noreferrer">vue-i18n：<code v-pre>&lt;i18n&gt;</code></a></li>
</ul>
<p>自定义块的处理需要依赖工具链。如果你想要在构建中集成你的自定义语块，请参见<RouteLink to="/guide/scaling-up/tooling.html#sfc-custom-block-integrations">相关工具链指南</RouteLink>获取更多细节。</p>
<h2 id="自动名称推导-automatic-name-inference" tabindex="-1"><a class="header-anchor" href="#自动名称推导-automatic-name-inference"><span>自动名称推导 {#automatic-name-inference}</span></a></h2>
<p>SFC 在以下场景中会根据<strong>文件名</strong>自动推导其组件名：</p>
<ul>
<li>开发警告信息格式</li>
<li>DevTools 审阅</li>
<li>递归组件自引用。例如一个名为 <code v-pre>FooBar.vue</code> 的组件可以在模板中通过 <code v-pre>&lt;FooBar/&gt;</code> 引用自己。(同名情况下) 这比明确注册/导入的组件优先级低。</li>
</ul>
<h2 id="预处理器-pre-processors" tabindex="-1"><a class="header-anchor" href="#预处理器-pre-processors"><span>预处理器 {#pre-processors}</span></a></h2>
<p>代码块可以使用 <code v-pre>lang</code> 这个 attribute 来声明预处理器语言，最常见的用例就是对 <code v-pre>&lt;script&gt;</code> 块使用 TypeScript：</p>
<div class="language-vue-html" data-highlighter="shiki" data-ext="vue-html" data-title="vue-html" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">&#x3C;</span><span style="--shiki-light:#E45649;--shiki-dark:#E06C75">script</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66"> lang</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">=</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379">"ts"</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">></span></span>
...
</div><p><code v-pre>lang</code> 在任意块上都能使用，比如我们可以在 <code v-pre>&lt;style&gt;</code> 标签上使用 <a href="https://sass-lang.com/" target="_blank" rel="noopener noreferrer">SASS</a> 或是 <code v-pre>&lt;template&gt;</code> 上使用 <a href="https://pugjs.org/api/getting-started.html" target="_blank" rel="noopener noreferrer">Pug</a>：</p>
<div class="language-vue-html line-numbers-mode" data-highlighter="shiki" data-ext="vue-html" data-title="vue-html" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">&#x3C;</span><span style="--shiki-light:#E45649;--shiki-dark:#E06C75">template</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66"> lang</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">=</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379">"pug"</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">></span></span>
...
<h2 id="src-导入-src-imports" tabindex="-1"><a class="header-anchor" href="#src-导入-src-imports"><span>Src 导入 {#src-imports}</span></a></h2>
<p>如果你更喜欢将 <code v-pre>*.vue</code> 组件分散到多个文件中，可以为一个语块使用 <code v-pre>src</code> 这个 attribute 来导入一个外部文件：</p>
...
</div><p>请注意 <code v-pre>src</code> 导入和 Webpack 的模块请求遵循相同的路径解析规则，这意味着：</p>
<ul>
<li>相对路径需要以 <code v-pre>./</code> 开头</li>
...
</div><p><code v-pre>src</code> 导入对自定义语块也同样适用：</p>
...
</div><h2 id="注释-comments" tabindex="-1"><a class="header-anchor" href="#注释-comments"><span>注释 {#comments}</span></a></h2>
<p>在每一个语块中你都可以按照相应语言 (HTML、CSS、JavaScript 和 Pug 等等) 的语法书写注释。对于顶层注释，请使用 HTML 的注释语法 <code v-pre>&lt;!-- comment contents here --&gt;</code></p>
</div></template>
