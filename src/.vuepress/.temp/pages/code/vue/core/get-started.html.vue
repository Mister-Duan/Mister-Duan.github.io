<template><div><h2 id="vue-js-是什么" tabindex="-1"><a class="header-anchor" href="#vue-js-是什么"><span>Vue.js 是什么</span></a></h2>
<h2 id="起步" tabindex="-1"><a class="header-anchor" href="#起步"><span>起步</span></a></h2>
...
<p><code v-pre>vue-cli</code> 已经过时，不建议在新项目中使用，请使用 <code v-pre>vite</code></p>
</div>
