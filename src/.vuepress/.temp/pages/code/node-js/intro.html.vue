<template><div><p>从本章开始，我们就正式开启 JavaScript 的后端开发之旅。</p>
...
<h2 id="浏览器大战和-node-js-的关系" tabindex="-1"><a class="header-anchor" href="#浏览器大战和-node-js-的关系"><span>浏览器大战和 Node.js 的关系</span></a></h2>
...
<h2 id="在-node-js-上运行的-javascript-相比其他后端开发语言的优势" tabindex="-1"><a class="header-anchor" href="#在-node-js-上运行的-javascript-相比其他后端开发语言的优势"><span>在 Node.js 上运行的 JavaScript 相比其他后端开发语言的优势</span></a></h2>
...
<h2 id="node-js-相关链接" tabindex="-1"><a class="header-anchor" href="#node-js-相关链接"><span>Node.js 相关链接</span></a></h2>
<ul>
<li>
