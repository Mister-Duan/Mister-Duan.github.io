<template><div><h2 id="pwd-命令" tabindex="-1"><a class="header-anchor" href="#pwd-命令"><span>pwd 命令</span></a></h2>
...
</div><h2 id="cd-命令" tabindex="-1"><a class="header-anchor" href="#cd-命令"><span>cd 命令</span></a></h2>
...
<p>在 Linux 系统中，根目录确实存在 <code v-pre>.</code>(当前目录)以及 <code v-pre>..</code>(当前目录的父目录)两个目录，但由于根目录是最顶级目录，因此根目录的 <code v-pre>..</code> 和 <code v-pre>.</code> 的属性和权限完全一致，也就是说，根目录的父目录是自身。</p>
</div>
<h2 id="ls-命令" tabindex="-1"><a class="header-anchor" href="#ls-命令"><span>ls 命令</span></a></h2>
<p>ls 命令，list 的缩写，是最常见的目录操作命令，其主要功能是显示当前目录下的内容。此命令的基本格式为:</p>
<div class="language-shellsession" data-highlighter="shiki" data-ext="shellsession" data-title="shellsession" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">[root@localhost ~]# ls [选项] 目录名称</span></span></code></pre>
</div><p>| 选项                                                | 功能                                                                                                                                              |
| --------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------- |
| -a                                                  | 显示全部的文件，包括隐藏文件(开头为 <code v-pre>.</code> 的文件)也一起罗列出来，这是最常用的选项之一。                                                             |
| -A                                                  | 显示全部的文件，连同隐藏文件，但不包括 <code v-pre>.</code> 与 <code v-pre>..</code> 这两个目录。                                                                                   |
| -d                                                  | 仅列出目录本身，而不是列出目录内的文件数据。                                                                                                      |
| -f                                                  | ls 默认会以文件名排序，使用 <code v-pre>-f</code> 选项会直接列出结果，而不进行排序。                                                                               |
| -F                                                  | 在文件或目录名后加上文件类型的指示符号，例如，<code v-pre>*</code> 代表可运行文件，<code v-pre>/</code> 代表目录，= 代表 socket 文件，                                              | 代表 FIFO 文件。 |
...
| -t                                                  | 以时间排序，而不是以文件名排序。                                                                                                                  |
| --color=never<br />--color=always<br />--color=auto | <code v-pre>never</code> 表示不依据文件特性给予颜色显示。<br /><code v-pre>always</code> 表示显示颜色，ls 默认采用这种方式。<br /><code v-pre>auto</code> 表示让系统自行依据配置来判断是否给予颜色。 |
...
<div class="hint-container tip">
<p class="hint-container-title">提示</p>
<p>ls 命令使用了 <code v-pre>-l</code> 选项，显示出文件的详细信息，此选项显示的这 7 列的含义分别是:</p>
<ul>
...
<h2 id="mkdir-命令" tabindex="-1"><a class="header-anchor" href="#mkdir-命令"><span>mkdir 命令</span></a></h2>
<p>mkdir 命令，是 make directories 的缩写，用于创建新目录，此命令所有用户都可以使用。</p>
<p>mkdir 命令的基本格式为:</p>
<div class="language-shellsession" data-highlighter="shiki" data-ext="shellsession" data-title="shellsession" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">[root@localhost ~]# mkdir [-mp] 目录名</span></span></code></pre>
</div><ul>
<li>-m 选项用于手动配置所创建目录的权限，而不再使用默认权限。</li>
<li>-p 选项递归创建所有目录，以创建 <code v-pre>/home/test/demo</code> 为例，在默认情况下，您需要一层一层的创建各个目录，而使用 <code v-pre>-p</code> 选项，则系统会自动帮您创建 <code v-pre>/home</code>、<code v-pre>/home/test</code> 以及 <code v-pre>/home/test/demo</code>。</li>
</ul>
<h2 id="rmdir-命令" tabindex="-1"><a class="header-anchor" href="#rmdir-命令"><span>rmdir 命令</span></a></h2>
<p>和 mkdir 命令(创建空目录)恰好相反，rmdir(remove empty directories 的缩写)命令用于删除空目录，此命令的基本格式为:</p>
<div class="language-shellsession" data-highlighter="shiki" data-ext="shellsession" data-title="shellsession" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">[root@localhost ~]# rmdir [-p] 目录名</span></span></code></pre>
</div><p>-p 选项用于递归删除空目录。</p>
<div class="hint-container tip">
<p class="hint-container-title">提示</p>
