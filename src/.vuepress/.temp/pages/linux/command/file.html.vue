<template><div><h2 id="touch-命令" tabindex="-1"><a class="header-anchor" href="#touch-命令"><span>touch 命令</span></a></h2>
...
<ul>
<li>访问时间 (Access Time，简称 atime): 只要文件的内容被读取，访问时间就会更新。例如，使用 <code v-pre>cat</code> 命令可以查看文件的内容，此时文件的访问时间就会发生改变。</li>
...
<h2 id="ln-命令" tabindex="-1"><a class="header-anchor" href="#ln-命令"><span>ln 命令</span></a></h2>
...
<ul>
<li>-s: 建立软链接文件。如果不加 <code v-pre>-s</code> 选项，则建立硬链接文件；</li>
<li>-f: 强制。如果目标文件已经存在，则删除目标文件后再建立链接文件；</li>
</ul>
<h3 id="ln-扩展介绍" tabindex="-1"><a class="header-anchor" href="#ln-扩展介绍"><span>ln 扩展介绍</span></a></h3>
<ul>
<li><RouteLink to="/linux/command/ln.html">点击前往</RouteLink></li>
</ul>
</div></template>
