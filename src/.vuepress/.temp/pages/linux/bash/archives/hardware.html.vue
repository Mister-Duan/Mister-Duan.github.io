<template><div><h1 id="硬件操作" tabindex="-1"><a class="header-anchor" href="#硬件操作"><span>硬件操作</span></a></h1>
<h2 id="df" tabindex="-1"><a class="header-anchor" href="#df"><span>df</span></a></h2>
<p><code v-pre>df</code> 命令查看硬盘信息。</p>
...
</div><h2 id="free" tabindex="-1"><a class="header-anchor" href="#free"><span>free</span></a></h2>
<p><code v-pre>free</code> 命令查看内存占用情况。</p>
...
</div><h2 id="硬盘" tabindex="-1"><a class="header-anchor" href="#硬盘"><span>硬盘</span></a></h2>
<p>文件<code v-pre>/etc/fstab</code> 配置系统启动时要挂载的设备。</p>
<div class="language-text" data-highlighter="shiki" data-ext="text" data-title="text" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>LABEL=/12               /               ext3        defaults        1   1</span></span>
...
<ul>
<li>设备名: 与物理设备相关联的设备文件(或设备标签)的名字，比如说<code v-pre>/dev/hda1</code>(第一个 IDE 通道上第一个主设备分区)。</li>
...
<h2 id="mount" tabindex="-1"><a class="header-anchor" href="#mount"><span>mount</span></a></h2>
<p><code v-pre>mount</code> 不带参数时，显示当前挂载的文件系统。</p>
...
<p><code v-pre>mount</code> 带参数时，用于将设备文件挂载到挂载点，<code v-pre>-t</code> 参数用来指定文件系统类型。</p>
...
</div><h2 id="umount" tabindex="-1"><a class="header-anchor" href="#umount"><span>umount</span></a></h2>
<p><code v-pre>umount</code> 命令用来卸载设备。</p>
...
</div><h2 id="fdisk" tabindex="-1"><a class="header-anchor" href="#fdisk"><span>fdisk</span></a></h2>
<p><code v-pre>fdisk</code> 命令用于格式化磁盘。</p>
...
</div><h2 id="mkfs" tabindex="-1"><a class="header-anchor" href="#mkfs"><span>mkfs</span></a></h2>
<p><code v-pre>mkfs</code> 命令用于在一个设备上新建文件系统。</p>
...
</div><h2 id="fsck" tabindex="-1"><a class="header-anchor" href="#fsck"><span>fsck</span></a></h2>
<p><code v-pre>fsck</code> 命令用于检查(修复)文件系统。</p>
...
</div><h2 id="dd" tabindex="-1"><a class="header-anchor" href="#dd"><span>dd</span></a></h2>
<p><code v-pre>dd</code> 命令用于将大型数据块，从一个磁盘复制到另一个磁盘。</p>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="dmidecode" tabindex="-1"><a class="header-anchor" href="#dmidecode"><span>dmidecode</span></a></h2>
<p><code v-pre>dmidecode</code> 命令用于输出 BIOS 信息。</p>
...
</div><p><code v-pre>dmidecode</code> 也支持关键词查看，关键词与类别的对应关系如下。</p>
<ul>
<li>bios 0, 13</li>
...
</div><h2 id="lspci" tabindex="-1"><a class="header-anchor" href="#lspci"><span>lspci</span></a></h2>
<p><code v-pre>lspci</code> 命令列出本机的所有 PCI 设备。</p>
...
</div><h2 id="lsusb" tabindex="-1"><a class="header-anchor" href="#lsusb"><span>lsusb</span></a></h2>
<p><code v-pre>lsusb</code> 命令用于操作 USB 端口。</p>
