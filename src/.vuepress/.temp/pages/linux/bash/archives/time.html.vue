<template><div><h1 id="时间管理" tabindex="-1"><a class="header-anchor" href="#时间管理"><span>时间管理</span></a></h1>
<h2 id="date-命令" tabindex="-1"><a class="header-anchor" href="#date-命令"><span>date 命令</span></a></h2>
<p><code v-pre>date</code> 命令用于输出当前时间</p>
...
</div><p><code v-pre>date</code> 命令后面用加号(<code v-pre>+</code>)指定显示的格式。</p>
...
<li>%d 一个月的第几天(01)</li>
<li>%D 日期，等同于<code v-pre>%m/%d/%y</code></li>
<li>%e 一个月的第几天，用空格补零，等同于<code v-pre>%_d</code></li>
<li>%F 完整的日期，等同于<code v-pre>%Y-%m-%d</code></li>
...
<h2 id="cal-命令" tabindex="-1"><a class="header-anchor" href="#cal-命令"><span>cal 命令</span></a></h2>
<p><code v-pre>cal</code> 命令用于显示日历。不带有参数时，显示的是当前月份。</p>
