...
<h2 id="cp" tabindex="-1"><a class="header-anchor" href="#cp"><span>cp</span></a></h2>
<p><code v-pre>cp</code> 命令用于将文件(或目录)拷贝到目的地。</p>
...
<ul>
<li><code v-pre>-a</code> 拷贝时保留所有属性，包括所有者与权限</li>
<li><code v-pre>-v</code> 显示拷贝的详细信息</li>
</ul>
<h2 id="mkdir" tabindex="-1"><a class="header-anchor" href="#mkdir"><span>mkdir</span></a></h2>
<p><code v-pre>mkdir</code> 命令用于新建目录。</p>
...
</div><h2 id="mv" tabindex="-1"><a class="header-anchor" href="#mv"><span>mv</span></a></h2>
<p><code v-pre>mv</code> 命令用于将源文件移动到目的地。</p>
...
<ul>
<li><code v-pre>-i</code> 覆盖已经存在的文件时，会提示确认</li>
<li><code v-pre>-u</code> 只移动目的地不存在的文件，或比目的地更新的文件</li>
</ul>
<h2 id="rm" tabindex="-1"><a class="header-anchor" href="#rm"><span>rm</span></a></h2>
<p><code v-pre>rm</code> 命令用于删除文件。</p>
<p>参数。</p>
<ul>
<li><code v-pre>-i</code> 文件存在时，会提示确认。</li>
<li><code v-pre>-r</code> 递归删除一个子目录</li>
<li><code v-pre>-f</code> 如果删除不存在的文件，不报错</li>
<li><code v-pre>-v</code> 删除时展示详细信息</li>
</ul>
<h2 id="ln" tabindex="-1"><a class="header-anchor" href="#ln"><span>ln</span></a></h2>
<p><code v-pre>ln</code> 命令用于建立链接文件。</p>
