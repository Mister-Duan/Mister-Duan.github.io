...
<!-- more -->
<h2 id="echo-命令" tabindex="-1"><a class="header-anchor" href="#echo-命令"><span>echo 命令</span></a></h2>
...
</div><p>上面例子中，<code v-pre>echo</code> 的参数是 <code v-pre>hello world</code>，可以原样输出。</p>
...
</div><p>上面例子中，<code v-pre>echo</code> 可以原样输出多行文本。</p>
<h3 id="n-参数" tabindex="-1"><a class="header-anchor" href="#n-参数"><span><code v-pre>-n</code> 参数</span></a></h3>
...
</div><p>上面例子中，<code v-pre>world</code> 后面直接就是下一行的提示符 <code v-pre>$</code>。</p>
...
</div><p>上面例子中，<code v-pre>-n</code> 参数可以让两个 <code v-pre>echo</code> 命令的输出连在一起，出现在同一行。</p>
<h3 id="e-参数" tabindex="-1"><a class="header-anchor" href="#e-参数"><span><code v-pre>-e</code> 参数</span></a></h3>
...
<h2 id="命令格式" tabindex="-1"><a class="header-anchor" href="#命令格式"><span>命令格式</span></a></h2>
...
</div><p>上面代码中，<code v-pre>command</code> 是具体的命令或者一个可执行文件，<code v-pre>arg1 ... argN</code> 是传递给命令的参数，它们是可选的。</p>
...
</div><p>上面这个命令中，<code v-pre>ls</code> 是命令，<code v-pre>-l</code> 是参数。</p>
...
</div><p>上面命令中，<code v-pre>-r</code> 是短形式，<code v-pre>--reverse</code> 是长形式，作用完全一样。前者便于输入，后者便于理解。</p>
...
</div><h2 id="空格" tabindex="-1"><a class="header-anchor" href="#空格"><span>空格</span></a></h2>
...
</div><p>上面命令中，<code v-pre>foo</code> 和 <code v-pre>bar</code> 之间有一个空格，所以 Bash 认为它们是两个参数。</p>
...
</div><p>上面命令中，<code v-pre>a</code> 和 <code v-pre>test</code> 之间有多个空格，Bash 会忽略多余的空格。</p>
<h2 id="分号" tabindex="-1"><a class="header-anchor" href="#分号"><span>分号</span></a></h2>
...
</div><p>上面例子中，Bash 先执行 <code v-pre>clear</code> 命令，执行完成后，再执行 <code v-pre>ls</code> 命令。</p>
<p>注意，使用分号时，第二个命令总是接着第一个命令执行，不管第一个命令执行成功或失败。</p>
<h2 id="命令的组合符-和" tabindex="-1"><a class="header-anchor" href="#命令的组合符-和"><span>命令的组合符 <code v-pre>&amp;&amp;</code> 和 <code v-pre>||</code></span></a></h2>
...
</div><p>上面命令的意思是，如果 <code v-pre>Command1</code> 命令运行成功，则继续运行 <code v-pre>Command2</code> 命令。</p>
<div class="language-bash" data-highlighter="shiki" data-ext="bash" data-title="bash" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#4078F2;--shiki-dark:#61AFEF">Command1</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF"> || </span><span style="--shiki-light:#4078F2;--shiki-dark:#61AFEF">Command2</span></span></code></pre>
</div><p>上面命令的意思是，如果 <code v-pre>Command1</code> 命令运行失败，则继续运行 <code v-pre>Command2</code> 命令。</p>
<p>下面是一些例子。</p>
...
</div><p>上面例子中，只要 <code v-pre>cat</code> 命令执行结束，不管成功或失败，都会继续执行 <code v-pre>ls</code> 命令。</p>
<div class="language-bash" data-highlighter="shiki" data-ext="bash" data-title="bash" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#4078F2;--shiki-dark:#61AFEF">cat</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379"> filelist.txt</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF"> &#x26;&#x26; </span><span style="--shiki-light:#4078F2;--shiki-dark:#61AFEF">ls</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66"> -l</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379"> filelist.txt</span></span></code></pre>
</div><p>上面例子中，只有 <code v-pre>cat</code> 命令执行成功，才会继续执行 <code v-pre>ls</code> 命令。如果 <code v-pre>cat</code> 执行失败(比如不存在文件 <code v-pre>flielist.txt</code>)，那么 <code v-pre>ls</code> 命令就不会执行。</p>
...
</div><p>上面例子中，只有 <code v-pre>mkdir foo</code> 命令执行失败(比如 <code v-pre>foo</code> 目录已经存在)，才会继续执行 <code v-pre>mkdir bar</code> 命令。如果 <code v-pre>mkdir foo</code> 命令执行成功，就不会创建 <code v-pre>bar</code> 目录了。</p>
<h2 id="type-命令" tabindex="-1"><a class="header-anchor" href="#type-命令"><span>type 命令</span></a></h2>
...
</div><p>上面代码中，<code v-pre>type</code> 命令告诉我们，<code v-pre>echo</code> 是内部命令，<code v-pre>ls</code> 是外部程序 (<code v-pre>/bin/ls</code>)。</p>
...
</div><p>如果要查看一个命令的所有定义，可以使用 <code v-pre>type</code> 命令的 <code v-pre>-a</code> 参数。</p>
...
</div><p>上面代码表示，<code v-pre>echo</code> 命令即是内置命令，也有对应的外部程序。</p>
...
</div><p>上面例子中，<code v-pre>bash</code> 是文件，<code v-pre>if</code> 是关键词。</p>
<h2 id="快捷键" tabindex="-1"><a class="header-anchor" href="#快捷键"><span>快捷键</span></a></h2>
<p>Bash 提供很多快捷键，可以大大方便操作。下面是一些最常用的快捷键，完整的介绍参见 <RouteLink to="/linux/bash/readline.html">行操作</RouteLink> 一章。</p>
<ul>
