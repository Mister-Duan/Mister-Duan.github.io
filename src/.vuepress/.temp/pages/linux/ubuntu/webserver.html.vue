<template><div><h1 id="网络服务器相关" tabindex="-1"><a class="header-anchor" href="#网络服务器相关"><span>网络服务器相关</span></a></h1>
<h2 id="ftp" tabindex="-1"><a class="header-anchor" href="#ftp"><span>ftp</span></a></h2>
<h3 id="vsftpd" tabindex="-1"><a class="header-anchor" href="#vsftpd"><span>vsftpd</span></a></h3>
<ul>
<li>
<p>安装</p>
...
</div><p>Nginx 默认安装在 <code v-pre>/etc/nginx</code> 目录下</p>
</li>
<li>
<p>配置</p>
<p>配置文件为 <code v-pre>nginx.conf</code>。</p>
<p>默认站点配置文件在 <code v-pre>/etc/nginx/sites-available/default</code></p>
<p>为了使得 Nginx 能使用 PHP，需要配置</p>
<div class="language-nginx" data-highlighter="shiki" data-ext="nginx" data-title="nginx" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"></span>
...
<h2 id="php" tabindex="-1"><a class="header-anchor" href="#php"><span>PHP</span></a></h2>
...
</div><h2 id="mysql" tabindex="-1"><a class="header-anchor" href="#mysql"><span>MySQL</span></a></h2>
...
</div><h2 id="nmp" tabindex="-1"><a class="header-anchor" href="#nmp"><span>NMP</span></a></h2>
...
</div><p>需要注意的是，Nginx 将端口转发给 php 默认的 9000 端口。而通过 apt-get 安装的 php 默认使用本地 sock 文件通信，需要对 php 的配置进行修改。要修改的文件位于: <code v-pre>/etc/php/7.2/fpm/pool.d/www.conf</code>，将</p>
