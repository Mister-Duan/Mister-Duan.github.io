<template><div><p>CPU 内部已经含有一些微指令，我们所使用的软件都要经过 CPU 内部的微指令集来达成才行。那这些指令集的设计主要又被分为两种设计理念，这就是目前世界上常见到的两种主要 CPU 架构，分别是: 精简指令集(RISC)与复杂指令集(CISC) 系统。</p>
<h2 id="精简指令集" tabindex="-1"><a class="header-anchor" href="#精简指令集"><span>精简指令集</span></a></h2>
...
<h2 id="复杂指令集" tabindex="-1"><a class="header-anchor" href="#复杂指令集"><span>复杂指令集</span></a></h2>
