...
<h2 id="启动图标的设计规范" tabindex="-1"><a class="header-anchor" href="#启动图标的设计规范"><span>启动图标的设计规范</span></a></h2>
<p>说到启动图标的规范，首先会想到的，就是 iOS 提供的图标栅格。通过这个栅格，会规范图形的尺寸，以及所处的位置。</p>
<figure><img src="@source/design/icon/assets/ios-grid.jpg" alt="iOS 提供的图标栅格" tabindex="0" loading="lazy"><figcaption>iOS 提供的图标栅格</figcaption></figure>
...
<figure><img src="@source/design/icon/assets/app-size.jpg" alt="不同的图标大小" tabindex="0" loading="lazy"><figcaption>不同的图标大小</figcaption></figure>
...
<figure><img src="@source/design/icon/assets/app-size2.jpg" alt="不同的图标大小" tabindex="0" loading="lazy"><figcaption>不同的图标大小</figcaption></figure>
...
<figure><img src="@source/design/icon/assets/app-generate.jpg" alt="不同图标生成" tabindex="0" loading="lazy"><figcaption>不同图标生成</figcaption></figure>
...
<figure><img src="@source/design/icon/assets/app-cut.jpg" alt="图表的剪切" tabindex="0" loading="lazy"><figcaption>图表的剪切</figcaption></figure>
<p>如果我们想要设计出正方形图形后预览真实的效果，就可以用我们准备的 PSD 模板，将正方形置入到模板中即可。</p>
<figure><img src="@source/design/icon/assets/app-template.jpg" alt="启动图标模板" tabindex="0" loading="lazy"><figcaption>启动图标模板</figcaption></figure>
<p>在设计已经确认以后，我们就要导出这些图标。因为启动图标有很多拟物的设计或会使用真实的摄影素材，所以应用商店提交的格式会选用位图格式而不是矢量格式，所以导出启动图标，只需要导出对应尺寸的 PNG 即可。</p>
<h2 id="启动图标的设计演示" tabindex="-1"><a class="header-anchor" href="#启动图标的设计演示"><span>启动图标的设计演示</span></a></h2>
<h3 id="图标形式" tabindex="-1"><a class="header-anchor" href="#图标形式"><span>图标形式</span></a></h3>
<figure><img src="@source/design/icon/assets/app-icon2.jpg" alt="图标形式" tabindex="0" loading="lazy"><figcaption>图标形式</figcaption></figure>
...
<figure><img src="@source/design/icon/assets/app-combine.jpg" alt="APP 组合" tabindex="0" loading="lazy"><figcaption>APP 组合</figcaption></figure>
<p>所以，如果我们要设计一款笔记应用，那么就可以先画一个线性的笔记图标，然后再将它置入格线模板中确认大小，再分别为它们上色，就可以完成设计了。</p>
<h3 id="文字形式" tabindex="-1"><a class="header-anchor" href="#文字形式"><span>文字形式</span></a></h3>
<figure><img src="@source/design/icon/assets/app-text2.jpg" alt="文字形式" tabindex="0" loading="lazy"><figcaption>文字形式</figcaption></figure>
...
<p>比如要设计一个我的应用，那么我可以取「超级帅的 Mister.Duan」的第一个字 ── 超，作为图标上方的文字。然后我选用「方正兰亭大黑」作为基础字形，对它进行重构即可。</p>
<figure><img src="@source/design/icon/assets/font-design.jpg" alt="字体设计" tabindex="0" loading="lazy"><figcaption>字体设计</figcaption></figure>
<p>最后建议，如果不是一些比较严肃或是传统的题材，尽量不要选用宋体或是楷体进行设计。</p>
<h3 id="拟物形式" tabindex="-1"><a class="header-anchor" href="#拟物形式"><span>拟物形式</span></a></h3>
<figure><img src="@source/design/icon/assets/app-tool.jpg" alt="拟物形式" tabindex="0" loading="lazy"><figcaption>拟物形式</figcaption></figure>
...
<figure><img src="@source/design/icon/assets/app-tool-design.jpg" alt="iOS 文件设计" tabindex="0" loading="lazy"><figcaption>iOS 文件设计</figcaption></figure>
