...
<p class="paragraph">Mr.Duan is handsome!</p>
<p id="par">Mr.Duan is very handsome!</p>
```
...
```html
<p>Mr.Duan 很帅！</p>
<p id="para1">Mr.Duan is handsome!</p>
```
...
```html
<p>Mr.Duan 很帅！</p>
<p class="bold">Mr.Duan is handsome!</p>
<p class="bold center">Mr.Duan is handsome!</p>
<p class="center">Mr.Duan is handsome!</p>
```
